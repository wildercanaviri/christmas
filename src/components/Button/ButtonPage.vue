...
<template>
  <div class="centerer mt-2 pb-24 md:pb-4">
    <button class="button-page" v-if="page != 1" @click="handlePrev()">Anterior</button>
    <button class="button-page" v-if="page < limit" @click="handleNext()">Siguiente</button>
  </div>
